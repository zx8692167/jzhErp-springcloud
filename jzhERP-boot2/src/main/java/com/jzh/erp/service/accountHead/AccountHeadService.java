package com.jzh.erp.service.accountHead;
...
import com.jzh.erp.datasource.mappers.AccountHeadMapper;
import com.jzh.erp.datasource.mappers.AccountHeadMapperEx;
import com.jzh.erp.datasource.mappers.AccountItemMapperEx;
...
public class AccountHeadService {
    ...
    public int insertAccountHead(JSONObject obj, HttpServletRequest request) throws Exception{
        ...
        try{
            ...
            accountHead.setCreator(userId==null?null:Long.valueOf(userId.toString()));
    ...
    public int batchDeleteAccountHeadByIds(String ids)throws Exception {
        ...
        //删除主表
        accountItemMapperEx.batchDeleteAccountItemByHeadIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
        //删除子表
        accountHeadMapperEx.batchDeleteAccountHeadByIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
