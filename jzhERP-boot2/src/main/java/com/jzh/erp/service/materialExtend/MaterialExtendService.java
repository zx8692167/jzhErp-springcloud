...
import com.jzh.erp.datasource.mappers.MaterialExtendMapper;
import com.jzh.erp.datasource.mappers.MaterialExtendMapperEx;
import com.jzh.erp.datasource.vo.MaterialExtendVo4List;
...
/*    @Resource
    ...
    public int insertMaterialExtend(MaterialExtend materialExtend)throws Exception {
        ...
        materialExtend.setCreateSerial(String.valueOf(loginName));
        materialExtend.setUpdateSerial(String.valueOf(loginName));
        int result =0;
        try{
