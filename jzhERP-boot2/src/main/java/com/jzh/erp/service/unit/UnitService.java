...
import com.jzh.erp.datasource.mappers.UnitMapper;
import com.jzh.erp.datasource.mappers.UnitMapperEx;
...
public class UnitService {
    ...
    public int batchDeleteUnitByIds(String ids)throws Exception {
        ...
        //校验通过执行删除操作
        try{
            result=unitMapperEx.batchDeleteUnitByIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
        }catch(Exception e){
            JzhException.writeFail(logger, e);
        }
        return result;
