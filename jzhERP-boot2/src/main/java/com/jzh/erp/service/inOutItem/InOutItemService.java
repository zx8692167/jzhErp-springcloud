...
import com.jzh.erp.datasource.mappers.InOutItemMapper;
import com.jzh.erp.datasource.mappers.InOutItemMapperEx;
...
public class InOutItemService {
    ...
    public int batchDeleteInOutItemByIds(String ids)throws Exception {
        ...
        try{
            result=inOutItemMapperEx.batchDeleteInOutItemByIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
        }catch(Exception e){
            JzhException.readFail(logger, e);
        }
        return result;
