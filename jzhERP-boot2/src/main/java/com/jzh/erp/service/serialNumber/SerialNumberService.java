...
import com.jzh.erp.datasource.mappers.MaterialMapperEx;
import com.jzh.erp.datasource.mappers.SerialNumberMapper;
import com.jzh.erp.datasource.mappers.SerialNumberMapperEx;
...
public class SerialNumberService {
    ...
    public int insertSerialNumber(JSONObject obj, HttpServletRequest request)throws Exception {
        ...
        try{
            ...
            serialNumberEx.setCreator(userId==null?null:Long.valueOf(userId.toString()));
            serialNumberEx.setUpdater(userId==null?null:Long.valueOf(userId.toString()));
    ...
    public int batchDeleteSerialNumberByIds(String ids) throws Exception{
        ...
        int result=0;
        try{
            result = serialNumberMapperEx.batchDeleteSerialNumberByIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
        }catch(Exception e){
            JzhException.writeFail(logger, e);
        }
        return result;
     ...
     * @return com.jzh.erp.datasource.entities.SerialNumberEx
     */
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
        ...
        try {
            if (StringUtil.isNotEmpty(materialCode)) {
                ...
                for (int i = 0; i < forNum; i++) {
                    ...
                    each.setCreator(Long.valueOf(userId.toString()));
                    each.setCreateTime(date);
                    each.setUpdater(Long.valueOf(userId.toString()));
        ...
        if ((BusinessConstants.SUB_TYPE_PURCHASE.equals(subType) ||
            ...
            for (String sn : snArr) {
                ...
                if (list == null || list.size() == 0) {
                    ...
                    serialNumber.setCreator(userId == null ? null : Long.valueOf(userId.toString()));
                    serialNumber.setUpdater(userId == null ? null : Long.valueOf(userId.toString()));
