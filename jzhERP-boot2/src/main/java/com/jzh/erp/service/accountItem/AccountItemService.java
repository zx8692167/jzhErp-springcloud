package com.jzh.erp.service.accountItem;
...
import com.jzh.erp.datasource.mappers.AccountItemMapper;
...
public class AccountItemService {
    ...
    public int batchDeleteAccountItemByIds(String ids) throws Exception{
        ...
        int result=0;
        try{
            result = accountItemMapperEx.batchDeleteAccountItemByIds(new Date(),userId==null?null:Long.valueOf(userId.toString()),idArray);
        }catch(Exception e){
            JzhException.writeFail(logger, e);
        }
        return result;
