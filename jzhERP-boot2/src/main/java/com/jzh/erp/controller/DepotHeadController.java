...
import com.jzh.erp.datasource.vo.DepotHeadVo4InDetail;
import com.jzh.erp.datasource.vo.DepotHeadVo4InOutMCount;
import com.jzh.erp.datasource.vo.DepotHeadVo4List;
import com.jzh.erp.datasource.vo.DepotHeadVo4StatementAccount;
...
public class DepotHeadController {
    ...
    public BaseResponseInfo findInOutDetail(@RequestParam("forceFlag")boolean forceFlag,
    ...
    public BaseResponseInfo findInOutMaterialCount(@RequestParam("forceFlag")boolean forceFlag,
                                            @RequestParam("currentPage") Integer currentPage,
                                         @RequestParam("pageSize") Integer pageSize,
                                         @RequestParam(value = "organId", required = false) Integer oId,
                                         @RequestParam("materialParam") String materialParam,
    ...
    public BaseResponseInfo findallocationDetail(@RequestParam("forceFlag")boolean forceFlag,
                                                @RequestParam("currentPage") Integer currentPage,
                                                 @RequestParam("pageSize") Integer pageSize,
                                                 @RequestParam("number") String number,
                                                 @RequestParam("materialParam") String materialParam,
