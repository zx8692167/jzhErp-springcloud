...
public interface SerialNumberMapperEx {
    ...
    /**
     * 卖出： update jzh_serial_number set is_Sell='1' ,depothead_Id='depotheadId' where 1=1 and material_Id='materialId'
    ...
    /**
     * 赎回：update jzh_serial_number set is_Sell='0',depothead_Id=null  where 1=1 and material_Id='materialId'
