...
public class SpringDocAutoConfiguration {
    ...
    public static final String WWW_DEMO_COM = "http://47.94.103.129:9998/doc.html";
    ...
    private Info apiInfo() {
        ...
        return new Info()
                .title("江天帝ERP Restful Api  登录网址 http://47.94.103.129:9998/login 用户名:jzh   密码：123456 ")
                .description("ERP接口描述   需登录才能访问接口：")
                .version("1.0.0")
                .contact(new Contact()
                        .name(
                                "江天帝ERP"
